      ...
      <div className="relative z-20 flex max-w-4xl flex-col items-start gap-8 text-left">
        ...
        >
          ...
          <h1 className="font-pixel-line text-5xl font-bold leading-none tracking-tight text-foreground text-balance md:text-7xl lg:text-9xl">
            CodePath
            <br />
            <span className="text-muted-foreground">CS Hub</span>
          </h1>

          <p className="max-w-prose font-mono text-sm leading-relaxed text-muted-foreground md:text-base">
            A peer-to-peer Computer Science learning platform created by students,
            for students. Master programming, algorithms, and web development
        ...
        <motion.div
          ...
          role="img"
          aria-label="ASCII art animation representing a learning terminal"
        >
...
{`> initializing learning_hub...
> loading 8 CS modules...
> courses: Algorithms, Web Dev, AI/ML
> tutors: 6 sessions available
> study_groups: 5 active groups
> resources: 16 materials ready
